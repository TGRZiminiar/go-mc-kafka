...
// FindOnePlayerProfileToRefresh
// UpdateOnePlayerCredential
// DeleteOnePlayerCredential
// FindOneAccessToken
// RolesCount
// AccessToken
// RefreshToken

func (m *AuthRepositoryMock) FindOnePlayerCredentail(pctx context.Context, credentialId string) (*auth.Credential, error) {
