...
func TestLogin(t *testing.T) {
	...
	// FindOnePlayerCredentail
	repoMock.On("FindOnePlayerCredentail", ctx, credentialIdSuccess.Hex()).Return(&auth.Credential{
	...
	repoMock.On("FindOnePlayerCredentail", ctx, credentialIdFailed.Hex()).Return(&auth.Credential{}, errors.New("error: player credential not found"))
